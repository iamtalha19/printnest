        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
          ...
          >
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-[15px] font-normal opacity-80 text-black leading-tight">
          ...
          <div className="lg:col-span-6 flex flex-col items-center text-center text-black space-y-8 order-1 lg:order-2">
            <div className="relative w-fit mx-auto">
              <motion.div
                className="hidden lg:block absolute -left-73 w-20 h-20 z-10"
                animate={{ y: [0, -15, 0] }}
                transition={{
                  duration: 4,
                  repeat: Infinity,
              ...
              <motion.div
                className="hidden lg:block absolute -right-73 w-18 h-18 z-10"
                animate={{ y: [0, 15, 0] }}
                transition={{
                  duration: 5,
                  repeat: Infinity,
              ...
              <motion.div
                className="hidden lg:block absolute -left-73 top-125 w-13 h-13 z-10"
                animate={{ y: [0, -10, 0] }}
                transition={{
                  duration: 3.5,
                  repeat: Infinity,
              ...
              <motion.h1
                className="text-[28px] md:text-[34px] lg:text-[52px] font-bold tracking-tight leading-[1.1] drop-shadow-xl text-black"
                initial="hidden"
                whileInView="visible"
                viewport={{ once: true }}
                variants={fadeUp}
